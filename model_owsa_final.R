...
simulate_strategies <- function(l_params, 
  ...
  with(as.list(l_params), {
    ...
    for (i in 1:n_strat){
      l_params_markov <- list(
        mean_los_non_mech = mean_los_non_mech, 
        mean_los_mech = mean_los_mech,
        mean_los_gen_ward = mean_los_gen_ward, 
        in_hos_mort = in_hos_mort, 
        six_month_mort = six_month_mort, 
        time_to_mort = time_to_mort,
        prob_disabled = prob_disabled, 
        los_mech_disabled = los_mech_disabled, 
        los_mech_not_disabled = los_mech_not_disabled,
        or_mech_vent_disabled = or_mech_vent_disabled, 
        utility_mech = utility_mech,
        utility_non_mech = utility_non_mech,
        utility_gen_ward = utility_gen_ward,
        utility_recovery_disabled = utility_recovery_disabled,
        utility_recovery_not_disabled = utility_recovery_not_disabled,
        qalies_post_recovery = qalies_post_recovery,
        costs_gen_ward = costs_gen_ward, 
        costs_mech_vent = costs_mech_vent, 
        costs_non_mech_vent = costs_non_mech_vent,
        costs_recovery_not_disabled = costs_recovery_not_disabled, 
        costs_recovery_disabled = costs_recovery_disabled, 
        intervention_effect_los= intervention_effect_los,
        intervention_effect_mort= intervention_effect_mort
      )
